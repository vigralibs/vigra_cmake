...
if(NOT _VigraAddDepIncludedOnce)
  ...
  file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/vad_activate_$<CONFIG>.bat" INPUT "${CMAKE_CURRENT_BINARY_DIR}/vad_activate.bat.generate")
  file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/vad_deactivate_$<CONFIG>.bat" INPUT "${VigraAddDepPath}/vad_deactivate.bat.in")
endif()
